package com.manoj.clean.ui.common.imageslider.utils
...
class LinearStartSnapHelper : LinearSnapHelper() {
    ...
    override fun attachToRecyclerView(recyclerView: RecyclerView?) {
        if (recyclerView != null && recyclerView.layoutManager != null && !recyclerView.layoutManager!!.canScrollHorizontally()) {
