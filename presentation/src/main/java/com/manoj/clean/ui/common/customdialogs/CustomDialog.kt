...
import com.manoj.clean.databinding.DialogConnectifyErrorBinding
import com.manoj.clean.databinding.DialogConnectifySuccessBinding
import com.manoj.clean.databinding.DialogEmojiBinding
import com.manoj.clean.databinding.DialogEmotionBinding
import com.manoj.clean.databinding.DialogFlashBinding
import com.manoj.clean.databinding.DialogFlatBinding
import com.manoj.clean.databinding.DialogRainbowBinding
import com.manoj.clean.databinding.DialogToasterBinding
...
class CustomDialog {
    ...
    class Builder(
        ...
        private var onClickListener: OnDialogClickListener = object : OnDialogClickListener {
            ...
            override fun onNegativeClick(dialog: Builder) {
                dialog.dismiss()
            }
        }
            ...
            when (dialogStyle) {
                ...
                DialogStyle.FLAT -> {
                    ...
                    DialogFlatBinding.bind(layoutView).apply {
                        ...
                        btnActionFlatCancel.setOnClickListener { onClickListener.onNegativeClick(this@Builder) }
                        btnActionFlatCancel.isVisible = dialogType == DialogType.INFO
                        when (dialogType) {
                            DialogType.ERROR -> {
                        ...
                        if (isDarkMode) {
                            ...
                            dialogTitleFlat.text = title
                            btnActionFlat.setOnClickListener { onClickListener.onClick(this@Builder) }
                            btnActionFlatCancel.setOnClickListener { onClickListener.onClick(this@Builder) }
                        }
                    }
                    dialogBuilder.setView(layoutView)
                    alertDialog = dialogBuilder.create()
